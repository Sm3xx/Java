...
public class Main {
	...
	public static void addCommand() {
		...
		CommandHandler.registerCommand(new String[] {"autochannel", "ac"}, new AutoChannel("AutoChannel", COMMANDS.AC_syntax, COMMANDS.AC_helptxt)); //TODO command to show all autochannels
